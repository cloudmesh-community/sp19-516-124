...
@garbeandy 
6
0 2 cloudmesh-community/sp19-516-124
 Code  Issues 1  Pull requests 2  Projects 0  Wiki  Insights
sp19-516-124/project-code/NativeProvider.py
@garbeandy garbeandy Update NativeProvider.py
8da0686 2 days ago
331 lines (269 sloc)  9.44 KB
    
# TO-DO - https://piazza.com/class/jql1e30dxswzu?cid=527

#e.g. the location for it should be: https://github.com/cloudmesh/cloudmesh-cloud/tree/master/cloudmesh/compute/azure
#I propose to rename this provider to : NativeProvider.py to distinguish it from AzProvider.py . using az and Provider.py .     using libcloud
...
@garbeandy 
13
1 18 cloudmesh/cloudmesh-cloud
 Code  Issues 24  Pull requests 0  Projects 0  Wiki  Insights
cloudmesh-cloud/cloudmesh/compute/azure/AzureVm.py
@laszewsk laszewsk pep8 formating
b92e61c 22 days ago
295 lines (240 sloc)  8.7 KB
